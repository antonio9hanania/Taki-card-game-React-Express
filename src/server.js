...
const roomManagement = require('./server/roomMenegment');
const rooms = require('./server/rooms');
const gameManagement = require('./server/gameManagement');
const gameManagementUtiles = require('./server/gameManagementUtiles');
...
app.use('/rooms', roomManagement);
app.use('/gameManagement', gameManagement);
